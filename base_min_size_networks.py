...
name = "base_min_size_networks" # name of the attempt
...
idt_coef = 0.5
# models
gen_mtp = Models.Generator(3, 3, num_res_blocks=1) # monet to photo
gen_ptm = Models.Generator(3, 3, num_res_blocks=1) # photo to monet, this is the one we care about later on
disc_m = Models.Discriminator(3, num_layers=4) # discriminates whether it is a monet image
disc_p = Models.Discriminator(3, num_layers=4) # discriminates whether it is an actual photo
