...
# Dataset
img_ds = Datasets.RandomPhotoAndMonetDataset(mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225))
img_dl = DataLoader(img_ds, batch_size=1, pin_memory=True)
sample_photo = torch.reshape(Datasets.PhotoDataset(mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225))[4], [1,3,256,256]) # shape must match the input expected by the network

# Training parameters

name = "base_alternate_normalization" # name of the attempt
