...
name = "base_lambda_0_adv_10" # name of the attempt
...
for epoch in range(epochs):
    ...
    for (real_photo, real_monet) in img_dl:
        ...
        adv_loss_monet = mse_loss(fake_monet_disc_result, result_if_real) * 10
        epoch_statistics["adv_loss_monet"] += adv_loss_monet.item()
        adv_loss_photo = mse_loss(fake_photo_disc_result, result_if_real) * 10
